 ...
 * INPUTS
 *********************************************/ 
int mdim = 8;	// dimension			// 2 or 184 or 8
int mdimcont = 3; // continuous dimension	// 1 or 66 or 3
//int mdimcat = 5; // categorical dimension	// 1 or 118 or 5
int mN = 100;	// number of instances	// 4 or 157681 or 100
...
main {
	...
	var prefixout = "output/" + infilename.split("/")[1].split(".")[0] + "-"; 	// prefix of all output files
